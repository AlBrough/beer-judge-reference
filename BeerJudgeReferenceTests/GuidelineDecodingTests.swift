...
final class GuidelineDecodingTests: XCTestCase {
    func testBundledManifestDeclaresBothProviders() throws {
        let url = try XCTUnwrap(Bundle.main.url(forResource: "guidelines-manifest", withExtension: "json"))
    ...
    func testBundledDatasetsHaveUniqueStylesAndUsefulContent() throws {
        let manifestURL = try XCTUnwrap(Bundle.main.url(forResource: "guidelines-manifest", withExtension: "json"))
        ...
        for descriptor in manifest.datasets {
            let url = try XCTUnwrap(Bundle.main.url(forResource: descriptor.localResource, withExtension: "json"))
